...
RUN echo "Let's build bgs" && \
	...
	apk --update fix && \
	apk --no-cache add git make gcc musl-dev libx11-dev libxft-dev imlib2-dev libxinerama-dev clang21 glib-dev curl jq && \
	cd ~ && \
...
ADD skel/.themes/current /usr/share/themes/current
